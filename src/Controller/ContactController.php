...
class ContactController extends AbstractController
{
    ...
    #[Route('admin/{token}', name: 'app_contact_show', methods: ['GET'])]
    ...
    #[Route('admin/{token}/edit', name: 'app_contact_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('admin/{id}', name: 'app_contact_delete', methods: ['POST'])]
